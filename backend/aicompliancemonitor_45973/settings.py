"""
Django settings for aicompliancemonitor_45973 project.
...
ROOT_URLCONF = 'aicompliancemonitor_45973.urls'
...
WSGI_APPLICATION = 'aicompliancemonitor_45973.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aicompliancemonitor_45973 API",
    "DESCRIPTION": "API documentation for aicompliancemonitor_45973 App",
    "VERSION": "v1",
}
